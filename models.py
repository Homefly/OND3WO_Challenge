...
from keras.layers import Dense, Dropout, LSTM, Bidirectional, Conv1D, Flatten
...
def create_CNN(lr=0.005, decay=0.001, layerNum = 1):
    """ Create Convolutional NN, from template
    ...
    model.add(Conv1D(filters = 10, kernel_size = 10, input_shape=(modelInputWidth, 1), padding = 'same', dilation_rate=1, use_bias = True))
    model.add(Flatten())
...
def convolutional_models():
    """ Creates dict of convolutional NN models and params
